...
impl GenericEvidence for AutoEvidence {
    ...
    fn create_evidence_from_dice(
        #[allow(unused)] cbor_tag: u64,
        #[allow(unused)] raw_evidence: &[u8],
        ...
        match SgxDcapEvidence::create_evidence_from_dice(cbor_tag, raw_evidence) {
            ...
            DiceParseEvidenceOutput::Ok(v) => {
                return DiceParseEvidenceOutput::Ok(Self(Box::new(v)))
            }
        }
        #[cfg(any(feature = "attester-tdx", feature = "verifier-tdx"))]
...
pub mod tests {
    ...
    use crate::{
        errors::*,
        tee::claims::{BUILT_IN_CLAIM_COMMON_EVIDENCE, BUILT_IN_CLAIM_COMMON_TEE_TYPE},
    };
